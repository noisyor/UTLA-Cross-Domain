...
with torch.no_grad():
    ...
    Intermediate_NTGE, Intermediate_GE  = test_intermediate(Profile_model)
    print('Final NTGE',Intermediate_NTGE) # print the minimum Intermediate GE for debugging
    print('Final GE',Intermediate_GE) # print the minimum Intermediate GE for debugging
